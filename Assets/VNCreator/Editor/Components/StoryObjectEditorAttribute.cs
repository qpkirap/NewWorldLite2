...
namespace VNCreator
{
    ...
    public class StoryObjectEditorAttribute : BaseEditorAttribute
    {
        /// <summary> 
        ...
        public StoryObjectEditorAttribute(Type type, Type editorType, params Type[] containerFilter) : base(type, editorType)
        {
